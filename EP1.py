...
def QuestA(txt):
    prep = 0
    for palavra in txt:
        if palavra[0] in letraZumbi and palavra[-1] in letraOutra:
            prep += 1
    print(prep)
